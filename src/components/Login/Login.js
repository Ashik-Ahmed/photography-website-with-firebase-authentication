...
const Login = () => {
    ...
    return (
        <div className='flex items-center justify-center bg-gray-600 h-screen mt-6'>
            <div className='md:w-1/4 w-3/4'>

                <h2 className='text-lg font font-semibold mb-4 text-white'>Please Login</h2>

                <form onSubmit={handleSignInWithEmailAndPassword} className=' bg-gray-800 p-6 shadow-xl rounded-md'>
                    <div className="mb-6">
                        <input type="email" id="email" ref={emailRef} className="bg-gray-400 border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Email" required />
                    </div>
                    <div className="mb-6">
                        <input type="password" id="password" ref={passwordRef} className="bg-gray-400 border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder='Password' required />
                    </div>
                    ...
                    <button className='text-pink-500 hover:underline italic'> <small>Forgot Password?</small></button>
                    <br />
                    ...
                    <div className=''>
                        ...
                        <button type="button" className="text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
