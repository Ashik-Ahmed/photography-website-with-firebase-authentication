            ...
            <div>
                ...
                <div className=' justify-center md:px-36'>
                    ...
                    <div className='text-right'>
                        <Link to='/services' className="inline-flex items-center mt-4 p-2 px-3 text-sm font-medium text-center text-white bg-pink-500 rounded-lg hover:bg-pink-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Explore All Package
